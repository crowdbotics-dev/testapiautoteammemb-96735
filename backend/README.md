...
## Project Structure
    ...
    ├── testapiautoteammemb_96735  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_96735`
...
2. Clone this repo and `cd testapiautoteammemb_96735`
